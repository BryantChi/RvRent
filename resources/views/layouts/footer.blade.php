        ...
        <div class="row justify-content-center">
            <div class="col-md-4 align-self-end text-md-left">
                <ul class="list-unstyled footer-list mt-4">
                    ...
                    <li><i class="fa-solid fa-fax"></i> <a href="tel:04-23804919"
                            class="text-foot">04-2380-4919</a></li>
                    <li><i class="fa-solid fa-location-dot"></i> <a href="https://goo.gl/maps/biKuasq6JusbMqXo7"
