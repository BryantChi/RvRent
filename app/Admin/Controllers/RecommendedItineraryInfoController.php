...
class RecommendedItineraryInfoController extends AdminController
{
    ...
    protected function grid()
    {
        return Grid::make(new RecommendedItineraryInfo(), function (Grid $grid) {
            ...
            $grid->column('itinerary_front_cover')->image();
            ...
            $grid->column('itinerary_front_cover')->hide();
    ...
    protected function form()
    {
        return Form::make(new RecommendedItineraryInfo(), function (Form $form) {
            ...
            $form->image('itinerary_front_cover')->move('images/itinerary/'.date('Ym').'/frontCover')->maxSize(1024)->rules('mimes:jpg,jpeg,png,gif');
            ...
            $form->multipleImage('itinerary_imgs')->move('images/itinerary/'.date('Ym'))->maxSize(3072)->rules('mimes:jpg,jpeg,png,gif|nullable')->sortable();//->uniqueName()
